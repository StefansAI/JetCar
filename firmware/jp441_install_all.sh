...
echo $password | sudo -SH pip3 install -U pip
echo $password | sudo -SH pip3 install -U pip testresources==2.0.1 setuptools==49.6.0
echo $password | sudo -SH pip3 install flask==1.1.2
echo $password | sudo -SH pip3 install -U --upgrade numpy
...
echo $password | sudo -SH pip3 install -U numpy==1.16.1 future==0.18.2 mock==3.0.5 h5py==2.10.0 keras_preprocessing==1.1.1 keras_applications==1.0.8 gast==0.2.2 futures==3.1.1 protobuf==3.14.0 pybind11==2.6.1
echo $password | sudo -SH pip3 install -U grpcio==1.34.0 absl-py==0.10.0 py-cpuinfo==7.0.0 psutil==5.7.3 portpicker==1.3.1 six==1.15.0 requests==2.25.0
echo $password | sudo -SH pip3 install Cython==0.29.21
echo $password | sudo -SH pip3 install h5py==2.10.0
echo $password | sudo -SH pip3 install -U astor==0.8.1 termcolor==1.1.0 keras-applications==1.0.8 keras-preprocessing==1.1.2 wrapt==1.12.1 google-pasta==0.2.0
echo $password | sudo -SH pip3 install --pre --extra-index-url https://developer.download.nvidia.com/compute/redist/jp/v44 tensorflow==2.3.1+nv20.11
...
echo $password | sudo -SH pip3 install Cython==0.29.21
echo $password | sudo -SH pip3 install numpy==1.16.1 torch-1.7.0-cp36-cp36m-linux_aarch64.whl
# install torchvision
...
echo $password | sudo -SH python3 setup.py install
cd ../

# install traitlets (master)
echo "============================= traitlets master ============================================"
echo $password | sudo -SH pip3 install traitlets
...
# install jupyter lab
echo "============================= jupyter lab ================================================="
echo $password | sudo -SH pip3 install -U jupyter jupyterlab
...
echo $password | sudo -S jupyter lab --generate-config -y
...
echo $password | sudo -SH pip3 install -e .
echo $password | sudo -S jupyter labextension install js

echo $password | sudo -S jupyter labextension list
